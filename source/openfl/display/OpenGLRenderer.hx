...
class OpenGLRenderer extends DisplayObjectRenderer
{
	...
	**/
	...
	@:noCompletion private function __setAdvancedBlendEquation(equation:Int):Void
	{
	...
	@:noCompletion private override function __setBlendMode(value:BlendMode):Void
	{
		...
		switch (value)
		{
			...
			case HARDLIGHT if (OpenGLRenderer.advancedBlend):
				__setAdvancedBlendEquation(0x929B);

			case DIFFERENCE if (OpenGLRenderer.advancedBlend):
				__setAdvancedBlendEquation(0x929E);
