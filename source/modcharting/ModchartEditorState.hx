...
import modcharting.FlxUIDropDownMenuCustom;
...
#if ((PSYCH || LEATHER) && !DISABLE_MODCHART_EDITOR)
class ModchartEditorState extends MusicBeatState implements IFlxUIState
{
    ...
    override public function update(elapsed:Float)
    {
        ...
        {
            #if PSYCH
            FlxG.sound.muteKeys = funkin.ui.states.TitleState.muteKeys;
			FlxG.sound.volumeDownKeys = funkin.ui.states.TitleState.volumeDownKeys;
			FlxG.sound.volumeUpKeys = funkin.ui.states.TitleState.volumeUpKeys;
            #end
    ...
    public var tooltips(default, null):flixel.addons.ui.FlxUITooltipManager = null;
    #if FLX_MOUSE
    ...
    public function getRequest(name:String, sender:IFlxUIWidget, data:Dynamic, ?params:Array<Dynamic>):Dynamic return null;
