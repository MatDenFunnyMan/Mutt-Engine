...
class ModchartFile
{
    ...
    public function loadFromJson(folder:String):ModchartJson //load da shit
    {
        ...
        var song:String = Paths.formatToSongPath(folder);

        var candidates:Array<String> = [];
        #if MODS_ALLOWED
        candidates.push(Paths.modsJson('songs/$song/modchart'));
        candidates.push(Paths.modsJson('$song/modchart'));
        #end
        candidates.push(Paths.json('songs/$song/modchart'));
        candidates.push(Paths.json('$song/modchart'));
