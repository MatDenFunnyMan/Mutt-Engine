...
class ReflectionFunctions
{
	...
	public static function parseSingleInstance(arg:Dynamic)
	{
		...
		if(argStr != null && argStr.length > instanceStr.length)
		{
			...
			if(index > -1)
			{
				...
				arg = (lastIndex > -1) ? Type.resolveClass(argStr.substring(lastIndex+2)) : (PlayState.instance != null ? PlayState.instance : MusicBeatState.getState());
	...
	public static function callMethodFromObject(classObj:Dynamic, funcStr:String, args:Array<Dynamic>)
	{
