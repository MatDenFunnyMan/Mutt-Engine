...
class LuaUtils
{
	...
	public static function getObjectDirectly(objectName:String, ?allowMaps:Bool = false):Dynamic
	{
		switch(objectName)
		{
			case 'this' | 'instance' | 'game':
				return PlayState.instance != null ? PlayState.instance : MusicBeatState.getState();
	...
	public static function cameraFromString(cam:String):FlxCamera {
		...
		if (camera == null || !Std.isOfType(camera, FlxCamera)) camera = (PlayState.instance != null) ? PlayState.instance.camGame : FlxG.camera;
		return camera;
	}
}