...
class Philly extends BaseStage
{
	...
	var _phillyWindow:FlxSprite;
	var phillyWindow(get, never):FlxSprite;
	function get_phillyWindow():FlxSprite{
		if(_phillyWindow == null) _phillyWindow = cast getStageObject('phillyWindow');
		return _phillyWindow;
	}

	var _phillyStreet:FlxSprite;
	var phillyStreet(get, never):FlxSprite;
	function get_phillyStreet():FlxSprite{
		if(_phillyStreet == null) _phillyStreet = cast getStageObject('phillyStreet');
		return _phillyStreet;
	}
	...
	override function createPost()
	{
		...
		insertBefore('phillyStreet', phillyTrain);
	}
